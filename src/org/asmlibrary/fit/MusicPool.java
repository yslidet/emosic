...
//                .build();
		...
		soundIds[0] = soundPool[0].load(context, R.raw.emo_1_happy, 1);
        soundIds[1] = soundPool[0].load(context, R.raw.emo_2_sad, 1);
        soundIds[2] = soundPool[0].load(context, R.raw.emo_3_fear, 1);
		soundIds[3] = soundPool[0].load(context, R.raw.emo_4_angry, 1);
		soundIds[4] = soundPool[0].load(context, R.raw.emo_5_disgust, 1);
		soundIds[5] = soundPool[0].load(context, R.raw.emo_6_surprise, 1);
		
		//soundPool[1] load music
		soundIds[6] = soundPool[1].load(context, R.raw.emo_1_happy, 1);
        soundIds[7] = soundPool[1].load(context, R.raw.emo_2_sad, 1);
        soundIds[8] = soundPool[1].load(context, R.raw.emo_3_fear, 1);
		soundIds[9] = soundPool[1].load(context, R.raw.emo_4_angry, 1);
		soundIds[10] = soundPool[1].load(context, R.raw.emo_5_disgust, 1);
		soundIds[11] = soundPool[1].load(context, R.raw.emo_6_surprise, 1);
		volume[0]=volume[1]=0;
	}
